...
public class ContractController {
    ...
    @ApiOperation(value = "query contract option list", notes = "No Pagination")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "query", name = "name", value = "Contract Name")
    })
    @RequestMapping(value = "/optionList", method = RequestMethod.GET)
    public ResponseEntity<Map<String, Object>> queryContractOptionList(@RequestParam(value = "name", required = false) String name) {
        Map<String, Object> map = new HashMap<>();
